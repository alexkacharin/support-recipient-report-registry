...
use Matodor\RegistryConstructor\models\data\Decimal\Settings;
use Matodor\RegistryConstructor\models\data\Decimal\ValueForm;
...
$activeField = $form->field($fieldValue, 'value_decimal', [
    'inputOptions' => [
        'class' => 'form-control',
